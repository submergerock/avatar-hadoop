...
if [ $# -le 3 ]; then
  echo "test02_S_to_P_newnode_with_sync.sh  <avatarnode0Local> <avatarnode0NFS> <avatarnode1Local> <avatarnode1NFS> <second>"
  exit 1
fi
echo
...
echo
echo \******************************************
echo \*    8.  restart avatarnode0 as standby with sync\*
echo \******************************************
echo
sleep $second
