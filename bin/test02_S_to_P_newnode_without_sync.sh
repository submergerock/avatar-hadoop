...
if [ $# -le 3 ]; then
  echo "test02_S_to_P_newnode_without_sync.sh  <avatarnode0Local> <avatarnode0NFS> <avatarnode1Local> <avatarnode1NFS> <second>"
  exit 1
fi
echo
...
sleep $second
echo \******************************************
echo \*    8.   delete editlog and fsimage of avatarnode0\*
echo \******************************************
echo
sleep $second
...
echo
echo \******************************************
echo \*    9.   format editlog and fsimage of avatarnode0\*
echo \******************************************
echo
sleep $second
ssh $avatarnode0IP $HADOOP_HOME/bin/hadoop org.apache.hadoop.hdfs.server.namenode.AvatarNode -zero -format
...
echo
echo \******************************************
echo \*    10.  restart avatarnode0 as standby without sync\*
echo \******************************************
echo
sleep $second
...
echo
echo \******************************************
echo \*    12.  stop avatarnode0 and avatarnode1 \*
echo \******************************************
echo
sleep $second
