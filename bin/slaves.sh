...
if [ "$avatardatanode" == "" -a -z "$sb" -a -n "$start" -a -n "$zero" ];
then
...
if [ "$avatardatanode" == "" -a -n "$sb" -a -n "$start" -a -n "$zero" ];
then
...
if [ "$avatardatanode" == "" -a -z "$sb" -a -n "$start" -a -n "$one" ];
then
...
if [ "$avatardatanode" == "" -a -n "$sb" -a -n "$start" -a -n "$one" ];
then
...
#################################avatar primary stop############################################
if [ "$avatardatanode" == "" -a -z "$sb" -a -n "$stop" ];
then
...
#################################avatar standby stop############################################
if [ "$avatardatanode" == "" -a -n "$sb" -a -n "$stop" ];
then
