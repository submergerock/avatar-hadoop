...
if [ $# -le 3 ]; then
  echo "test02_S_to_P.sh  <avatarnode0Local> <avatarnode0NFS> <avatarnode1Local> <avatarnode1NFS> <second>"
  exit 1
fi
echo
...
echo
echo \******************************************
echo \*    8.   avatarnode1 enter safemode    \*
echo \******************************************
echo
sleep $second
ssh $avatarnode1IP $HADOOP_HOME/bin/hadoop org.apache.hadoop.hdfs.tools.DFSAdmin -safemode enter
sleep $second


echo
echo \******************************************
echo \*    9.   saveNamespace on avatarnode1    \*
echo \******************************************
echo
sleep $second
ssh $avatarnode1IP $HADOOP_HOME/bin/hadoop org.apache.hadoop.hdfs.tools.DFSAdmin -saveNamespace
sleep $second

echo
echo \******************************************
echo \*    10. avatarnode1 leave safemode            \*
echo \******************************************
echo
sleep $second
ssh $avatarnode1IP $HADOOP_HOME/bin/hadoop org.apache.hadoop.hdfs.tools.DFSAdmin -safemode leave
sleep $second

sleep $second
echo \******************************************
echo \*    11.   delete editlog and fsimage of avatarnode0\*
echo \******************************************
echo
sleep $second
...
echo
echo \******************************************
echo \*    12.   format editlog and fsimage of avatarnode0\*
echo \******************************************
echo
sleep $second
ssh $avatarnode0IP $HADOOP_HOME/bin/hadoop org.apache.hadoop.hdfs.server.namenode.AvatarNode -zero -format
...
echo
echo \******************************************
echo \*    15.  stop avatarnode0 and avatarnode1 \*
echo \******************************************
echo
sleep $second
