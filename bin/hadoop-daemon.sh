...
case $startStop in
  ...
  (start)
    ...
    echo starting on  $command, logging to $log
    #echo ========================hadoop-daemon.sh ============================
    cd "$HADOOP_HOME"
    #echo nohup nice -n  $HADOOP_NICENESS  "$HADOOP_HOME"/bin/hadoop --config $HADOOP_CONF_DIR $command "$@"  "$log"
    #echo $!
    #echo ========================hadoop-daemon.sh ============================
