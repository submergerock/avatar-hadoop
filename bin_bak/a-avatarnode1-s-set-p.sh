...
ssh $HADOOP_SSH_OPTS 192.168.1.9 "cd ${HADOOP_HOME}/; ${HADOOP_HOME}/bin/hadoop --config ${HADOOP_HOME}/conf/ org.apache.hadoop.hdfs.AvatarShell -one -setAvatar primary" \
