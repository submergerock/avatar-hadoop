...
import org.apache.hadoop.hdfs.NNBenchWithoutMRGetBlock;
...
public class AllTestDriver {
  ...
  public static void main(String argv[]){
    ...
    try {
      ...
      pgd.addClass("nnbenchwithoutmrgetblock", NNBenchWithoutMRGetBlock.class, "block:A benchmar that stresses the namenode and datanode");      
      pgd.addClass("nnbenchwithoutmr", NNBenchWithoutMR.class, "no get block:A benchmar that stresses the namenode and datanode");      
