...
//add by wl826214---------2012.2.16---start

  private Configuration conf = null;
//add by wl826214---------2012.2.16---end
  /**
  ...
  synchronized void updateNeededReplications(Block block,
	  ...
	  //LOG.info("-------FSNamesystem.updateNeededReplications()-------");
  ...
  void startFile(String src, PermissionStatus permissions,
    ...
    startFileInternal(src, permissions, holder, clientMachine, overwrite, false,
                      replication, blockSize,index);
//    long endTime1 = System.currentTimeMillis();
//    if(endTime1 - startTime > 200)
//    LOG.info("wl---------startFile(1) "+", index : " + index +"  use time : " + (endTime1 - startTime));
    
    getEditLog().logSync();
//    long endTime2 = System.currentTimeMillis();
//    if(endTime2 - endTime1 > 200)
//    LOG.info("wl---------startFile(2) "+", index : " + index +"  use time : " + (endTime2 - endTime1));
    if (auditLog.isInfoEnabled()) {
      final FileStatus stat = dir.getFileInfo(src);
      logAuditEvent(UserGroupInformation.getCurrentUGI(),
                    Server.getRemoteIp(),
...
//    if(endTime3 - endTime2 > 200)
//    LOG.info("wl---------startFile(3) "+", index : " + index +"  use time : " + (endTime3 - endTime2));
  }
...
//    long endTime2 = System.currentTimeMillis();
//    if(endTime2 - endTime1 > 20)
//    LOG.info("wl---------startFileInternal(2)"+", index : " + indexStartFile +"  use time : " + (endTime2 - endTime1) );
    try {
      INode myFile = dir.getFileINode(src);
      
//      long endTime3 = System.currentTimeMillis();
//      if(endTime3 - endTime2 > 20)
//      LOG.info("wl---------startFileInternal(3)"+", index : " + indexStartFile +"  use time : " + (endTime3 - endTime2) );
//      
//      long endTime1 = System.currentTimeMillis();
//      if(endTime1 - startTime > 20)
//      LOG.info("wl---------startFileInternal(1) "+", index : " + index +" use time : " + (endTime1 - startTime) );
//     
...
//      if(endTime4 - endTime3 > 20)
//      LOG.info("wl---------startFileInternal(4)"+", index : " + indexStartFile +"  use time : " + (endTime4 - endTime3));
//      
      ...
      if (append) {
       ...
       checkFsObjectLimit();
        ...
        /*if (NameNode.stateChangeLog.isDebugEnabled()) {
         ...
         NameNode.stateChangeLog.info("DIR* NameSystem.startFile: "
                                       +"add "+src+" to namespace for "+holder);
        //end add
      }
      
      //long endTime5 = System.currentTimeMillis();
      //if(endTime5 - startTime > 20)
      //LOG.info("wl---------startFileInternal() "+", index : " + index +"  use time : " + (endTime5 - startTime));
  ...
  LocatedBlock appendFile(String src, String holder, String clientMachine
    ...
    startFileInternal(src, null, holder, clientMachine, false, true, 
                      (short)maxReplication, (long)0,(long)0);
    getEditLog().logSync();
  ...
  public LocatedBlock getAdditionalBlock(String src, 
    ...
    /*NameNode.stateChangeLog.debug("BLOCK* NameSystem.getAdditionalBlock: file "
                                  +src+" for "+clientName);
    */
    NameNode.stateChangeLog.info("BLOCK* NameSystem.getAdditionalBlock: file "
            +src+" for "+clientName);    
...
//    if(clientNode != null){
//    	 LOG.info("clientNode : " + clientNode.getHostName());
//    } else {
//    	 LOG.info("clientNode : null!!!!!!!!" );
//    }
    
   
    // choose targets for the new block tobe allocated.
    replicator.clientName = clientName;
  ...
  public synchronized boolean abandonBlock(Block b, String src, String holder
     ...
     * NameNode.stateChangeLog.debug("BLOCK* NameSystem.abandonBlock: "
                                  +b+"of file "+src);
    */                        
	NameNode.stateChangeLog.info("BLOCK* NameSystem.abandonBlock: "
              +b+"of file "+src);	  
	//end add
  ...
  public CompleteFileStatus completeFile(String src, String holder,long index) throws IOException {
//	  long startTime = System.currentTimeMillis();
    CompleteFileStatus status = completeFileInternal(src, holder,index);
//    long endTime = System.currentTimeMillis();
//    if(endTime - startTime > 200)
//    LOG.info("wl---------completeFile(1) "+", index : " + index +"  use time : " + (endTime - startTime));
    getEditLog().logSync();
//    long endTime1 = System.currentTimeMillis();
//    if(endTime1 - endTime > 200)
//    LOG.info("wl---------completeFile(2) "+", index : " + index +"  use time : " + (endTime1 - endTime));
    return status;
  }


  private synchronized CompleteFileStatus completeFileInternal(String src, 
                                                String holder,long index) throws IOException {
	  //long startTime = System.currentTimeMillis();
...
//       long endTime1 = System.currentTimeMillis();
//       if(endTime1 - startTime > 20)
//       LOG.info("wl---------completeFileInternal(1)  "+", index : " + index +" use time : " + (endTime1 - startTime));
...
//    long endTime2 = System.currentTimeMillis();
//    if(endTime2 - endTime1 > 20)
//    LOG.info("wl---------completeFileInternal(2)   "+", index : " + indexCompleteFile +" use time : " + (endTime2 - endTime1 ));
    finalizeINodeFileUnderConstruction(src, pendingFile);
    
       NameNode.stateChangeLog.info("DIR* NameSystem.completeFile: file " + src
                                  + " is closed by " + holder);
       //long endTime3 = System.currentTimeMillis();
      // if(endTime3 - startTime > 20)
       //LOG.info("wl---------completeFileInternal()   "+", index : " + index +" use time : " + (endTime3 - startTime ));
  ...
  synchronized boolean checkFileProgress(INodeFile v, boolean checkall) {
    if (checkall) {
      ...
      for (Block block: v.getBlocks()) {
    	int blockHasReplication = blocksMap.numNodes(block);
        if ( blockHasReplication < this.minReplication) {
          NameNode.stateChangeLog.info("wzt debuginfo:DIR* NameSystem.checkFileProgress: current block has "
             + blockHasReplication +" < "+ this.minReplication +
             " need to wait for replication to complete");
          return false;
        }
      }
    } else {
  ...
  private synchronized boolean renameToInternal(String src, String dst
	  ...
	  NameNode.stateChangeLog.info("DIR* NameSystem.renameTo: " + src + " to " + dst);
	  //end add
	  if (isInSafeMode()){
  ...
  void internalReleaseLeaseOne(Lease lease, String src,
		...
		internalReleaseLeaseOne(lease, src, (INodeFileUnderConstruction) iFile,
				discardLastBlock);
	}
  ...
  class ReplicationMonitor implements Runnable {
    ...
    public void run() {
      while (fsRunning) {
        try {
          //LOG.info("wl-------FSNamesystem.ReplicationMonitor()----- replicationRecheckInterval = " + replicationRecheckInterval);
          computeDatanodeWork();
...
//	  LOG.info("wl-------FSNamesystem.computeDatanodeWork()--111---");
//	  
//	  if(this.conf.get("dfs.replication.work.multiplier.per.iteration") == null){
//		  LOG.info("wl-------null!!!!!!!!!!-----");
//	  } else {
//		  LOG.info("wl-------not   null!!!!!!!!!!-----" 
//				  + this.conf.get("dfs.replication.work.multiplier.per.iteration"));
//	  }
    ...
    synchronized(heartbeats) {
      blocksToProcess = (int)(heartbeats.size() 
        ...
        //add by wl826214---------2012.2.16---start
          * this.conf.getInt("dfs.replication.work.multiplier.per.iteration", 10));
    //add by wl826214---------2012.2.16---start
    ...
    //LOG.info("wl-------FSNamesystem.computeDatanodeWork()----- workFound : " + workFound);
    //LOG.info("wl----++++++++++FSNamesystem.computeDatanodeWork()++++++++++");
    return workFound;
  }
  ...
  private int computeReplicationWork(
    ...
    // Choose the blocks to be replicated
	  //LOG.info("wl-------FSNamesystem.computeReplicationWork()-----");
    ...
    for (int i=0; i<blocksToReplicate.size(); i++) {
      for(Block block : blocksToReplicate.get(i)) {
    	  //LOG.info("wl------block = " + block.getBlockId());
  ...
  synchronized List<List<Block>> chooseUnderReplicatedBlocks(int blocksToProcess) {
    ...
    synchronized(neededReplications) {
      ...
      //LOG.info("blocksToProcess = " + blocksToProcess );
      //LOG.info("neededReplications.size() = " + neededReplications.size() );
...
//    int i = 0;
//    for(List<Block> lb : blocksToReplicate){
//    	LOG.info("i = " + i++ );
//    	
//    	LOG.info("List<Block>.size() = " + lb.size() );
//    }
  ...
  boolean computeReplicationWorkForBlock(Block block, int priority) {
	  //LOG.info("wl--------------FSNamesystem.computeReplicationWorkForBlock()----------");
    ...
    synchronized (this) {
      synchronized (neededReplications) {
        ...
        //LOG.info("wl--------------FSNamesystem.computeReplicationWorkForBlock()-----000-----");
        ...
        //LOG.info("wl--------------FSNamesystem.computeReplicationWorkForBlock()-----000-----srcNode=" + srcNode);
        ...
        if(srcNode == null) // block can not be replicated from any node
          return false;
        //LOG.info("wl--------------FSNamesystem.computeReplicationWorkForBlock()-----111-----");
    ...
    //LOG.info("wl--------------FSNamesystem.computeReplicationWorkForBlock()----222------");
    // choose replication targets: NOT HODING THE GLOBAL LOCK
    DatanodeDescriptor targets[] = replicator.chooseTarget(
        requiredReplication - numEffectiveReplicas,
        srcNode, containingNodes, null, block.getNumBytes(),new StringBuffer());
    if(targets.length == 0)
      return false;
  ...
  private DatanodeDescriptor chooseSourceDatanode(
    ...
    //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----000---srcNode = " + srcNode);
    while(it.hasNext()) {
   
      DatanodeDescriptor node = it.next();
      //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----111---node = " + node);
      Collection<Block> excessBlocks = 
        excessReplicateMap.get(node.getStorageID());
//      LOG.info("wl------FSNamesystem.chooseSourceDatanode()----222---excessBlocks.size() = " 
//    		  + excessBlocks.size());
//      LOG.info("wl------FSNamesystem.chooseSourceDatanode()----222---excessBlocks.contains(block) = " 
//    		  + excessBlocks.contains(block));
      ...
      //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----222---srcNode = " + srcNode);
      if ((nodesCorrupt != null) && nodesCorrupt.contains(node)){
        continue;
       }
      //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----333---srcNode = " + srcNode);
      //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----333---node.getNumberOfBlocksToBeReplicated() = " 
    		 // + node.getNumberOfBlocksToBeReplicated());
      //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----333---maxReplicationStreams = " 
    		 //+ maxReplicationStreams);
      if(node.getNumberOfBlocksToBeReplicated() >= maxReplicationStreams)
      {
          continue;
         }
      //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----444---srcNode = " + srcNode);
      ...
      //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----555---srcNode = " + srcNode);
      ...
      //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----666---srcNode = " + srcNode);
      if(srcNode.isDecommissionInProgress())
      {
          continue;
         }
      //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----777---srcNode = " + srcNode);
    ...
    //LOG.info("wl------FSNamesystem.chooseSourceDatanode()----888---srcNode = " + srcNode);
    return srcNode;
  }
  ...
  void processPendingReplications() {
    ...
    if (timedOutItems != null) {
      ...
      //LOG.info("wl-------FSNamesystem.processPendingReplications()----- timedOutItems.length = " + timedOutItems.length);
  ...
  private void removeDatanode(DatanodeDescriptor nodeInfo) {
	LOG.info("-------FSNamesystem.removeDatanode()-------");
    synchronized (heartbeats) {
      if (nodeInfo.isAlive) {
        updateStats(nodeInfo, false);
    ...
    int i = 0;
    Iterator<Block> itt = nodeInfo.getBlockIterator();
    while(itt.hasNext()){
    	i++;
    	itt.next();
    	//LOG.info("i = " + i );
  ...
  synchronized void removeStoredBlock(Block block, DatanodeDescriptor node) {
	  //LOG.info("-------FSNamesystem.removeStoredBlock()-------");
  ...
  public DatanodeDescriptor getRandomDatanode() {
    return replicator.chooseTarget(1, null, null, 0,new StringBuffer())[0];
  }
...
//begin-------add by wanglei ---------2011.12.4
   ...
   * client to "try again later".
   */
  public LocatedBlock getAdditionalBlockAssignDN(String src, 
                                         String clientName,
...
//    }
    ...
    // choose targets for the new block tobe allocated.
    replicator.clientName = clientName;
    DatanodeDescriptor targets[] = replicator.chooseTargetAssignDN(replication,
                                                           clientNode,
                                                           null,
                                                           blockSize,
                                                           DNIPs);
