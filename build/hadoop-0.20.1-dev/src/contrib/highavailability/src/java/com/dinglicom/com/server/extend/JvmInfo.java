...
public class JvmInfo {
	...
	public ThreadInfo getThreadinfo(long id){
		return thMx.getThreadInfo(id);
	}
	
	public ThreadInfo[] getThreadinfo(long[] ids){
		return thMx.getThreadInfo(ids);
	}
	public long[] getDeadThread(){
	     return thMx.findDeadlockedThreads();		
	}
	public double getSysLoad(){
		double dSysLoad = osMxb.getSystemLoadAverage();
		return dSysLoad;
	}
